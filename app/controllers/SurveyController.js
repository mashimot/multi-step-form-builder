...
app.controller('SurveyController', [ '$scope', '$uibModal', 'SurveyFactory', 'TabService', 'SortableService', '$routeParams', '$timeout', function($scope, $uibModal, SurveyFactory, TabService, SortableService ,$routeParams, $timeout){
