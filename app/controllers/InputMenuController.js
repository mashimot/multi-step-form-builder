...
app.controller('InputMenuController', [ '$scope', '$routeParams', 'SortableService', 'InputService', 'SurveyFactory', function($scope, $routeParams, SortableService, InputService, SurveyFactory){
    var vm = this;
