(function() {
    ...
    addEditContent.$inject = ['$uibModal', 'SurveyFactory', 'TabService', 'Notification'];

    function addEditContent($uibModal, SurveyFactory, TabService, Notification){
        return {
            restrict: 'EA',
            scope: {
                pageContent: '=',
            ...
            link: function(scope, elem, attr){
                ...
                function ConfigModalController($scope, $uibModalInstance, render, pageContent, typeEvent, pageId, SurveyFactory) {
                    var isChanged       = false;
                    ...
                    function pushNewContent(){
                        ...
                        delete model._id;
                        SurveyFactory.pushNewContent( null,  $scope.pageId, model).then(function(data){
                            if(data.success){
                                $uibModalInstance.close(data.message);
                            }
                        });
